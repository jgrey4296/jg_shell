        ...
        */
        "help" : function(globalData,values){
            return {
                ...
                "set action $actionId arith" : ["$let $operator $value","Set a variable (defined in data) arithmetic operation. Can be $bound"],
                "set action $actionId regex" : ["$let $regex","Set the action's regex action for the $var. regex is of the form /a/A/g"],
